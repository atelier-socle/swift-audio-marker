# Contributing to swift-audio-marker
...
- Test files go in `Tests/AudioMarkerTests/`
- Use `#expect` and `#require` for assertions

## Pull Request Guidelines

- **Clear title** describing the change (e.g., "Add ID3v2 chapter reader")
...
- Minimal code sample or test audio file if applicable

## Project Structure

- `Sources/AudioMarker/` — core library (model, ID3, MP4, validator, encoder, exporter, streaming, batch)
- `Sources/CLI/` — command-line tool (swift-argument-parser)
- `Tests/AudioMarkerTests/` — unit and integration tests
- `Tests/Fixtures/` — test audio files (small MP3/M4A samples)
